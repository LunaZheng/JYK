      ...
      this.$nextTick(function() {
        if(this.isSingle) {
          ...
          if(newVal) {
            ...
            this.canvas.setWidth(pW * this.deskScale)
            this.canvas.setHeight(pH * this.deskScale)
            this.cPath.setWidth(pW * 0.25)
            this.cPath.setHeight(pH * 0.25)
            this.canvas.clear()
            ...
            var data2 = newVal[1].layer.map((item)=> {
              ...
              this.paga2AddIdx = newVal[0].layer.length - 1
            ...
            // console.log(newVal[0].layer.length, this.bgColorNum, newVal[0].photocount, this.fillImgNum)
          ...
          if(oldVal.length > 0) {
            var photocount = oldVal[0].photocount * 1 + oldVal[1].photocount * 1
            if(photocount > 0) {
              this.saveToJson(this.oldCnavasObjs, JSON.stringify(oldVal))
            }
          }
