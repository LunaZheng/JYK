    ...
    <div class="edit-content">
      ...
      <div class="canvas-box">
        <div @dragover="allowDrop">
          <!-- <fabricBox1 v-show="isSingle" idName="canvasSingle" ref="fabricBox1" :isSingle="isSingle" :pageData="pageJsonData" :curDragImg="curDragImg" :dragType="dragType" :fontFamily="fontFamily" :curDragDecorate="curDragDecorate" @getOldPageData="getOldPageData"></fabricBox1> -->

          <!-- <fabricBox2 v-show="!isSingle" idName="canvasDouble" ref="fabricBox2" :pageData="pageDataDouble" :curDragImg="curDragImg" :dragType="dragType" :fontFamily="fontFamily" :curDragDecorate="curDragDecorate" :deskScale="deskScale" :fStep="cStep" :fState="state" :loadCanvas="loadCanvas" @getStep="getStep" @getState="getState" @getJson="getPagePrevData"></fabricBox2> -->
